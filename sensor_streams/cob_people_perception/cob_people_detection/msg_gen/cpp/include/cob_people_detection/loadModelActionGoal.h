/* Auto-generated by genmsg_cpp for file /home/xinyan/groovy_workspace/sandbox/hri7633/sensor_streams/cob_people_perception/cob_people_detection/msg/loadModelActionGoal.msg */
...
struct loadModelActionGoal_ {
  ...
  typedef  ::cob_people_detection::loadModelGoal_<ContainerAllocator>  _goal_type;
   ::cob_people_detection::loadModelGoal_<ContainerAllocator>  goal;
...
{
template<class ContainerAllocator> struct IsMessage< ::cob_people_detection::loadModelActionGoal_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::cob_people_detection::loadModelActionGoal_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
template<class ContainerAllocator> struct HasHeader< ::cob_people_detection::loadModelActionGoal_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::cob_people_detection::loadModelActionGoal_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
