...
class getDetectionsResult(genpy.Message):
  _md5sum = "e5ee628ace54b3e286e7e7871ac04b49"
...
"""
  ...
  _slot_types = ['cob_people_detection_msgs/DetectionArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.detections is None:
        self.detections = cob_people_detection_msgs.msg.DetectionArray()
    else:
      self.detections = cob_people_detection_msgs.msg.DetectionArray()
