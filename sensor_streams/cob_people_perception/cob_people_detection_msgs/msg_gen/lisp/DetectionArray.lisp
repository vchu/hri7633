...
(cl:defclass <DetectionArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (detections
    :reader detections
    :initarg :detections
    :type (cl:vector cob_people_detection_msgs-msg:Detection)
   :initform (cl:make-array 0 :element-type 'cob_people_detection_msgs-msg:Detection :initial-element (cl:make-instance 'cob_people_detection_msgs-msg:Detection))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DetectionArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectionArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_people_detection_msgs-msg:<DetectionArray> is deprecated: use cob_people_detection_msgs-msg:DetectionArray instead.")))
...
(cl:defmethod detections-val ((m <DetectionArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_people_detection_msgs-msg:detections-val is deprecated.  Use cob_people_detection_msgs-msg:detections instead.")
  (detections m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DetectionArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'cob_people_detection_msgs-msg:Detection))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectionArray>)))
  ...
  "cob_people_detection_msgs/DetectionArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectionArray)))
  "Returns string type for a message object of type 'DetectionArray"
  "cob_people_detection_msgs/DetectionArray")
