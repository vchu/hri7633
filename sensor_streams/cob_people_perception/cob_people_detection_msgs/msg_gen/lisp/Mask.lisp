...
(cl:defmethod cl:initialize-instance :after ((m <Mask>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mask)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_people_detection_msgs-msg:<Mask> is deprecated: use cob_people_detection_msgs-msg:Mask instead.")))

(cl:ensure-generic-function 'roi-val :lambda-list '(m))
(cl:defmethod roi-val ((m <Mask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_people_detection_msgs-msg:roi-val is deprecated.  Use cob_people_detection_msgs-msg:roi instead.")
  (roi m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Mask>)))
  ...
  "cob_people_detection_msgs/Mask")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Mask)))
  "Returns string type for a message object of type 'Mask"
  "cob_people_detection_msgs/Mask")
