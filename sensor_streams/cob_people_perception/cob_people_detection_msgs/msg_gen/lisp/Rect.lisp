...
(cl:defmethod cl:initialize-instance :after ((m <Rect>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rect)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_people_detection_msgs-msg:<Rect> is deprecated: use cob_people_detection_msgs-msg:Rect instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Rect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_people_detection_msgs-msg:x-val is deprecated.  Use cob_people_detection_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Rect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_people_detection_msgs-msg:y-val is deprecated.  Use cob_people_detection_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <Rect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_people_detection_msgs-msg:width-val is deprecated.  Use cob_people_detection_msgs-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <Rect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_people_detection_msgs-msg:height-val is deprecated.  Use cob_people_detection_msgs-msg:height instead.")
  (height m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Rect>)))
  ...
  "cob_people_detection_msgs/Rect")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Rect)))
  "Returns string type for a message object of type 'Rect"
  "cob_people_detection_msgs/Rect")
