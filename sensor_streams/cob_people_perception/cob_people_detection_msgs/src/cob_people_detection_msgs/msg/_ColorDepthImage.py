"""autogenerated by genpy from cob_people_detection_msgs/ColorDepthImage.msg. Do not edit."""
import sys
...
class ColorDepthImage(genpy.Message):
  ...
  _type = "cob_people_detection_msgs/ColorDepthImage"
...
"""
  ...
  _slot_types = ['cob_people_detection_msgs/Rect','sensor_msgs/Image','sensor_msgs/Image','cob_people_detection_msgs/Rect[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.head_detection is None:
        self.head_detection = cob_people_detection_msgs.msg.Rect()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cob_people_detection_msgs.msg.Rect()
        _x = val1
        start = end
        end += 16
