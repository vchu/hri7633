"""autogenerated by genpy from cob_people_detection_msgs/ColorDepthImageArray.msg. Do not edit."""
import sys
...
class ColorDepthImageArray(genpy.Message):
  ...
  _type = "cob_people_detection_msgs/ColorDepthImageArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','cob_people_detection_msgs/ColorDepthImage[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cob_people_detection_msgs.msg.ColorDepthImage()
        ...
        for i in range(0, length):
          val2 = cob_people_detection_msgs.msg.Rect()
          _x = val2
          start = end
          end += 16
          (_x.x, _x.y, _x.width, _x.height,) = _struct_4i.unpack(str[start:end])
